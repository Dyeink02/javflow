...
**🎭 演员图鉴 → 🕷️ 抓取资料 → 📁 整理文件 →🎬 生成媒体库元数据 → 🔔 追踪更新**
...
| 🧩 工作区 | 🎯 解决的问题 | 📦 主要产物 |
| --- | --- | --- |
| 🎭 **演员图鉴** | 浏览真实女优榜单、查演员资料和作品，一键把资料带进爬虫 | 女优榜单、演员档案、作品封面 |
...
- 📊 查看来自 FANZA 等多渠道的真实女优榜单。
- 🔎 支持中文名、日文名和别名搜索，内置本地别名库，未收录时自动解析。
- 🧑‍🎤 浏览演员资料和作品封面，图片本地缓存，翻页不重复下载。
- 🕷️ 一键把选中的演员信息带入 JAV 爬虫配置，省去手动复制粘贴。
...
0.4.3 新增了第五个工作区 **演员图鉴**，让“发现演员”成为工作流的第一个入口：

- 📊 **真实女优榜单**：接入 FANZA 等多渠道榜单，支持查看排名和人气变化。
- 🧑‍🎤 **演员资料页**：档案、头像、写真与宣传照一站查看，图片本地缓存复用。
- 🎞️ **作品浏览**：按演员浏览作品列表和封面，可直接跳转对应页面。
- 🔎 **中日别名搜索**：内置本地别名库，输入中文名或别名即可命中标准日文名。
- 🕷️ **爬虫联动**：一键将选中的演员信息带入 JAV 爬虫配置，也能快速建立订阅。
