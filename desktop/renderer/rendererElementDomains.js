...
(function initializeRendererElementDomains(globalScope) {
  ...
  function collectOrganizerElements(scope) {
    ...
    return {
      ...
      organizerBrowseCrawlFileButton: scope.getElementById('organizer-browse-crawl-file'),
      organizerBrowseCrawlFolderButton: scope.getElementById('organizer-browse-crawl-folder'),
      organizerCrawlOutputHistory: scope.getElementById('organizer-crawl-output-history'),
      ...
      organizerMagnetCount: scope.getElementById('organizer-magnet-count'),
      ...
      organizerAutoSubscribeFromOutput: scope.getElementById('organizer-auto-subscribe-from-output'),
  ...
  function collectSubscriptionElements(scope) {
    ...
    return {
      ...
      subscriptionListResultCount: scope.getElementById('subscription-list-result-count'),
      subscriptionRefreshSummary: scope.getElementById('subscription-refresh-summary'),
      subscriptionGlobalActressFilter: scope.getElementById('subscription-global-actress-filter'),
      subscriptionApplyActressFilterButton: scope.getElementById('subscription-apply-actress-filter'),
