...
(function registerWailsPlatformBridge(globalScope) {
  ...
  const RETRYABLE_COMMANDS = new Set([
    ...
    'app:save-actress-ranking-history',
  ...
  function buildDesktopCommandApi() {
    return {
      ...
      validateProxy: twoValueCommand('app:validate-proxy', 'proxyValue', 'options'),
	      checkProxyRegion: optionsCommand('app:check-proxy-region'),
	      backfillRankingHistory: optionsCommand('app:backfill-ranking-history'),
      ...
      openMagnetFile: singleValueCommand('app:open-magnet-file', 'targetOutput'),
	      ...
	      saveActressRankingHistory: optionsCommand('app:save-actress-ranking-history'),
	      cacheActressRankingAvatars: optionsCommand('app:cache-actress-ranking-avatars'),
  ...
  function buildDesktopEventApi() {
    return {
      ...
      onActressRankingLog: directEventSubscription('actressranking.log'),
      onAtlasRankingLog: directEventSubscription('atlas:ranking:log'),
