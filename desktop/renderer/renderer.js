...
(function initializeRenderer(globalScope) {
  ...
  function buildStateControllerOptions(
    ...
    return {
      ...
      actressFilteredBox: elements.actressFilteredBox,
      actressFilteredItemsView: elements.actressFilteredItemsView,
      actressFilteredTotalView: elements.actressFilteredTotalView,
